...
//        try {
//            final ResultSet execute = connect.execute("CREATE KEYSPACE NewsMute WITH replication = {'class':'SimpleStrategy', 'replication_factor':1};");
...
//            final Session test = cluster.connect("NewsMute");
//        }
